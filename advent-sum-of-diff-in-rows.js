...
function minArray( arr ){
     return arr.reduce(function( a,b ){
         //console.log( a + ' ve ' + b + ' ---> ' +Math.min( a,b ));
        return Math.min(a,b);
    });
}

//console.log( minArray( [1567, 3246, 4194, 151, 3112, 903, 1575, 134, 150, 4184, 3718, 4077, 180, 4307, 4097, 1705] ) );
